...
test("creates an internal review draft with all seven friction pillars", () => {
  const draft = new FrictionAuditService().createDraft({ companyName: "Apex Service Group", websiteUrl: "https://apex.example", contactName: "Avery", email: "avery@apex.example", serviceArea: "Phoenix Metro", primaryService: "HVAC service" }, researchResult());
