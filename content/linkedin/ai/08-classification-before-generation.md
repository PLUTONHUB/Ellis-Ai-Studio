---
title: Classification before generation
topic: ai
...
Classification before generation is not a tool decision. It is a systems decision.
...
- Carousel text: 1. Classification before generation 2. Define the outcome 3. Connect the system 4. Measure the result 5. Request an assessment.
- Image caption: Classification before generation — an Ellis AI Studio systems engineering principle.
...
- X version: Classification before generation. Start with the outcome, owner, source of truth, and metric. Then build the system.
- Instagram adaptation: Classification before generation. Save this for your next business systems planning session.
