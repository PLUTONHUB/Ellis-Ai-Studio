---
title: Pluto: Opportunity scoring
topic: pluto
...
Pluto: Opportunity scoring is not a tool decision. It is a systems decision.
...
- Carousel text: 1. Pluto: Opportunity scoring 2. Define the outcome 3. Connect the system 4. Measure the result 5. Request an assessment.
- Image caption: Pluto: Opportunity scoring — an Ellis AI Studio systems engineering principle.
...
- X version: Pluto: Opportunity scoring. Start with the outcome, owner, source of truth, and metric. Then build the system.
- Instagram adaptation: Pluto: Opportunity scoring. Save this for your next business systems planning session.
