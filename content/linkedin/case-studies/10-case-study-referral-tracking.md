---
title: Case study: Referral tracking
topic: case-studies
...
Case study: Referral tracking is not a tool decision. It is a systems decision.
...
- Carousel text: 1. Case study: Referral tracking 2. Define the outcome 3. Connect the system 4. Measure the result 5. Request an assessment.
- Image caption: Case study: Referral tracking — an Ellis AI Studio systems engineering principle.
...
- X version: Case study: Referral tracking. Start with the outcome, owner, source of truth, and metric. Then build the system.
- Instagram adaptation: Case study: Referral tracking. Save this for your next business systems planning session.
