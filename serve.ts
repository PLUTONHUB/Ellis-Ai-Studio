...
// The production build creates this file; it is intentionally absent before `bun run build`.
// @ts-expect-error build artifact is generated by TanStack Start/Vite
