...
const industries = ["Roofing", "HVAC", "Plumbing", "Electrical", "Cleaning", "Landscaping", "Contractors", "Auto Repair", "Dentists", "Med Spas", "Gyms"];
const steps = [["Discovery", "We learn about your business and understand what you’re trying to improve."], ["Plan", "We recommend the right solution for your business."], ["Build", "We design, develop, test, and launch everything."], ["Support", "Need updates later? We’re here when you need us."]];

export function MarketingPage() {
  return <div className="site-shell">
    <header className="site-nav"><a className="brand-link" href="#home"><BrandLogo variant="icon" className="brand-logo brand-logo-nav" /></a><nav aria-label="Primary navigation"><a href="#home">Home</a><a href="#services">Services</a><a href="#industries">Industries</a><a href="#about">About</a><a href={bookingUrl} target="_blank" rel="noreferrer">Contact</a></nav><a className="button nav-cta" href={bookingUrl} target="_blank" rel="noreferrer">Request a Business Assessment</a></header>
    <main>
      <section className="hero" id="home"><div className="hero-orbit" aria-hidden="true"/><div className="wrap hero-content"><p className="eyebrow">AI systems engineering</p><h1>Intelligent infrastructure for business growth</h1><p className="lede">We build intelligent websites, custom software, AI agents, and automation that help businesses acquire customers and operate with greater clarity.</p><div className="actions"><a className="button" href={bookingUrl} target="_blank" rel="noreferrer">Request a Business Assessment <span aria-hidden="true">→</span></a><a className="button button-secondary" href="#services">Explore AI Systems</a></div></div></section>
      ...
      <section className="callout"><div className="wrap"><div><p className="eyebrow">Build the next system</p><h2>Plan the infrastructure that helps your business scale with clarity.</h2></div><a className="button button-light" href={bookingUrl} target="_blank" rel="noreferrer">Request a Business Assessment <span aria-hidden="true">→</span></a></div></section>
...
function InquiryForm() {
  return <div className="inquiry"><p>Choose a time that works for you, and we’ll come prepared to discuss your business goals.</p><a className="button" href={bookingUrl} target="_blank" rel="noreferrer">Schedule Your Free Consultation <span aria-hidden="true">→</span></a></div>;
}
