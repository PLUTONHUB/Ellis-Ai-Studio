...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Ellis AI Studio | Business Growth Partner" },
      {
        name: "description",
        content:
          "Ellis AI Studio is a Business Growth Partner for service businesses, helping teams improve revenue, operations, and customer experience.",
      },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_US" },
      { property: "og:site_name", content: "Ellis AI Studio" },
      { property: "og:title", content: "Ellis AI Studio | Business Growth Partner" },
