...
export const Route = createFileRoute("/services/")({
  head: () => pageHead({
    title: "Infrastructure Capabilities | Ellis AI Studio",
    description: "Explore the connected digital infrastructure Ellis AI Studio engineers across customer experience, intelligence, operations, growth, and analytics.",
    path: "/services",
  }),
